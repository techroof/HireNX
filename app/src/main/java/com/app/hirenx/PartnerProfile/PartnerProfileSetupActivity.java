...
public class PartnerProfileSetupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etGender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(PartnerProfileSetupActivity.this).setTitle("Select Your Gender")
        ...
        etMaritalStatus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(PartnerProfileSetupActivity.this).setTitle("Select Your Marital Status")
        ...
        etDocumentType.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                new AlertDialog.Builder(PartnerProfileSetupActivity.this).setTitle("Select Your Document Type")
        ...
        btnPartnerSetup1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
