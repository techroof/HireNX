...
public class ProfileClientFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // uId = firebaseAuth.getUid();
        ...
        tvPartnerName = view.findViewById(R.id.tv_client_partner_name);
        tvPartnerDateofBirth = view.findViewById(R.id.tv_client_partner_dob);
        tvPartnerGender = view.findViewById(R.id.tv_client_gender);
        tvPartnerMaritalStatus = view.findViewById(R.id.tv_client_marital_status);
        tvPartnerEmail = view.findViewById(R.id.tv_client_email_address);
        tvPartnerPhoneNumber = view.findViewById(R.id.tv_client_phone_number);
        tvPartnerAddress1 = view.findViewById(R.id.tv_client_address1);
        tvPartnerAddress2 = view.findViewById(R.id.tv_client_address2);
        tvPartnerLandMark = view.findViewById(R.id.tv_client_landmark);
        tvPartnerVillage = view.findViewById(R.id.tv_client_city_village);
        tvPartnerState = view.findViewById(R.id.tv_client_state);
        ...
        firestore.collection("users").document(uId).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
            ...
            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                if(task.isComplete()){
                    ...
                    Glide.with(ProfileClientFragment.this)
